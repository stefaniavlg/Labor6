...
public class DeleteStudentScene {
    /**
     * creates a Stage to delete a student in
    ...
    public static Stage getScene(AdminController adminController){
        ...
        Label lb_title = new Label("Delete Student");
        ...
        //Check if student exists, if not, write error
        ...
        btn_submit.setOnAction((ActionEvent e)->{
            ...
            if(adminController.existsStudent(first,last)){
                adminController.deleteStudent(first, last);
                stage.close();
            }
            else {
