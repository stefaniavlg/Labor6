...
public class DeleteTeacherScene {
    /**
     * creates a Stage to delete a teacher in
    ...
    public static Stage getScene(AdminController adminController){
        ...
        Label lb_title = new Label("Delete Teacher");
        ...
        //Check if teacher exists, if not, shows error
        ...
        btn_submit.setOnAction((ActionEvent e)->{
            ...
            if(adminController.existsTeacher(first,last)){
                adminController.deleteTeacher(first, last);
                stage.close();
            }
            else {
